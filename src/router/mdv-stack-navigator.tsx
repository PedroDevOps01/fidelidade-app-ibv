...
export const MdvStackNavigator = () => {
  ...
  const initialRouteName = dadosUsuarioData.pessoaMdv
    ? "user-mdv-home"
    : "no-mdv-found";
  ...
  return (
    <CreateMdvProvider>
      ...
      >
        <MdvStack.Screen
          name="no-mdv-found"
          component={NoMdvFound}
          options={{ headerShown: false }}
        />
        <MdvStack.Screen
          name="user-mdv-home"
          component={UserMdvHome}
          options={{ headerShown: false }}
        />
        <MdvStack.Screen
          name="user-mdv-registration"
          component={UserMdvRegistration}
          options={{ title: "Dados bancários" }}
        />
        <MdvStack.Screen
          name="user-mdv-terms"
          component={UserMdvTerms}
          options={{ title: "Termos de uso" }}
        />
        <MdvStack.Screen
          name="user-mdv-bank-list"
          component={UserMdvBankList}
          options={{ title: "Dados bancários" }}
        />
        <MdvStack.Screen
          name="new-contract-navigator"
          component={NewContractStackNavigator}
          options={{ headerShown: false }}
        />
        <MdvStack.Screen
          name="user-mdv-sales-details"
          component={UserMdvSalesDetails}
          options={{ headerShown: true, title: "Minhas vendas" }}
        />
      </MdvStack.Navigator>
    </CreateMdvProvider>
  );
