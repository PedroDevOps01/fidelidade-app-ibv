...
export default function UserPaymentCreditCardScreen() {
  ...
  const totalValue = route.params!.item.vlr_parcela_cpc;
  ...
  async function payWithCreditCard(payload: any) {
    ...
    try {
      ...
      if (response.status == 200) {
        navigate('user-payment-successfull-screen', { reset: true, name: 'user-contratos-screen' });
      }
    } catch (err: any) {
            ...
            <View>
              ...
              <View style={{ marginVertical: 16, alignItems: 'center' }}>
                <Text
                  ...
                  {`Valor: 1x de R$: ${maskBrazilianCurrency(totalValue)}`}
                </Text>
              </View>
              <Button
